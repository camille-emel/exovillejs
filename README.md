...
2. Écrivez une fonction `displayCity` qui prend en paramètre les données d'une commune (`city`), c'est à dire un élément du tableau `cities` et retourne sous forme de chaîne de caractères `"Code département - nom de la ville"`. (exemple : `74 - Annecy`)
3. Utilisez ces fonctions pour afficher dans la console les villes d'un département.
